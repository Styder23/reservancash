                        ...
                        <div class="bg-gray-50 rounded-lg p-6 mb-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                                ...
                                <div class="bg-white p-4 rounded-lg shadow-sm">
                                    ...
                                    <p class="text-gray-900 font-semibold">
                                        {{ \Carbon\Carbon::parse($reservaSeleccionada->created_at)->format('h:i A') }}
                                    </p>
                                </div>
                                ...
                                <div class="bg-white p-4 rounded-lg shadow-sm">
                                    ...
                                    <p class="text-gray-900 font-semibold">
                                        {{ \Carbon\Carbon::parse($reservaSeleccionada->created_at)->format('d M Y') }}
                                    </p>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="p-6">
                                        <div class="flex items-center mb-4">
                                            <div class="flex-shrink-0">
                                                <svg class="h-10 w-10 text-yellow-500" fill="none"
                                                    stroke="currentColor" viewBox="0 0 24 24">
                                                    <path stroke-linecap="round" stroke-linejoin="round"
                                                        stroke-width="2"
                                            ...
                                            <div class="ml-3">
                                                <h3 class="text-lg font-medium text-gray-900">Solicitar Cancelación
                                                </h3>
                                            </div>
                                        </div>
                                        ...
                                        <div class="bg-yellow-50 border border-yellow-200 rounded-md p-4 mb-4">
                                            <div class="flex">
                                                <svg class="flex-shrink-0 h-5 w-5 text-yellow-400" fill="none"
                                                    stroke="currentColor" viewBox="0 0 24 24">
                                                    <path stroke-linecap="round" stroke-linejoin="round"
                                                        stroke-width="2"
                                                        d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-2.5L13.732 4c-.77-.833-1.964-.833-2.732 0L4.082 16.5c-.77.833.192 2.5 1.732 2.5z">
                                                ...
                                                <div class="ml-3">
                                                    <h4 class="text-sm font-medium text-yellow-800">Solicitud de
                                                        Cancelación</h4>
                                                    <p class="text-sm text-yellow-700 mt-1">
                                                        Tu solicitud será revisada por nuestro equipo. Te contactaremos
                                        ...
                                        <div class="bg-blue-50 border border-blue-200 rounded-md p-4 mb-4">
                                            <h4 class="text-sm font-medium text-blue-800 mb-2">Información de Contacto
                                            </h4>
                                        ...
                                        <div class="bg-gray-50 border border-gray-200 rounded-md p-3 mb-4">
                                            <h4 class="text-sm font-medium text-gray-800 mb-1">Política de Cancelación
                                            </h4>
                                            <p class="text-xs text-gray-600">
                                                Las cancelaciones están sujetas a nuestras políticas. El reembolso
                                        ...
                                        <div class="flex justify-end space-x-3">
                                            ...
                                            <button wire:click="solicitarCancelacion"
                                                ...
                                                :disabled="!$wire.motivoCliente || $wire.motivoCliente.length < 10">
                                                Enviar Solicitud
                                            </button>
                                        </div>
                                        >>>>>>> e13dc3fdde241eeee3457772942d308bc1e262d9
                                    </div>
                                </div>
                            </div>
                        @endif
                            ...
                            @if ($modalDetallesVisible && $reservaSeleccionada)
                                <div
                                    ...
                                    <div
                                        ...
                                        <div class="sticky top-0 bg-white border-b border-gray-200 p-6 rounded-t-lg">
                                            <div class="flex items-center justify-between">
                                                <h3 class="text-2xl font-bold text-gray-900">Detalles de la Reserva
                                                </h3>
                                                <button wire:click="cerrarModalDetalles"
                                        ...
                                        <div class="p-6">
                                            ...
                                            <!-- Información de la reserva -->
                                            <div class="bg-gray-50 rounded-lg p-6 mb-6">
                                                <h4 class="text-xl font-semibold text-gray-800 mb-4">Información de la
                                                    Reserva</h4>
                                                ...
                                                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                                                    ...
                                                    <div class="bg-white p-4 rounded-lg shadow-sm">
                                                        <div class="flex items-center mb-2">
                                                            ...
                                                            <span class="font-medium text-gray-700">Fecha de
                                                                Viaje</span>
                                                        </div>
                                                        <p class="text-gray-900 font-semibold">
                                                            {{ \Carbon\Carbon::parse($reservaSeleccionada->fechareserva)->format('d M Y') }}
                                                    ...
                                                    <div class="bg-white p-4 rounded-lg shadow-sm">
                                                        ...
                                                        <p class="text-gray-900 font-bold text-lg">S/.
                                                            {{ number_format($reservaSeleccionada->total_pago ?? 0, 2) }}
                                                        </p>
                                                    </div>
                                            ...
                                            @if ($reservaSeleccionada->notas || $reservaSeleccionada->motivo_cliente)
                                                <div class="mb-6 space-y-4">
                                                    ...
                                                    @if ($reservaSeleccionada->notas)
                                                        <div
                                                            class="bg-blue-50 rounded-lg p-6 border-l-4 border-blue-400">
                                                            <h4
                                                            ...
                                                            <p class="text-blue-700">{{ $reservaSeleccionada->notas }}
                                                            </p>
                                                        </div>
                                                    @endif
                                                    ...
                                                    @if ($reservaSeleccionada->motivo_cliente)
                                                        <div
                                                            class="bg-red-50 rounded-lg p-6 border-l-4 border-red-400">
                                                            <h4
                                                                class="text-lg font-semibold text-red-800 mb-2 flex items-center">
                                                                <svg class="w-5 h-5 mr-2" fill="none"
                                                                    stroke="currentColor" viewBox="0 0 24 24">
                                                                    <path stroke-linecap="round"
                                                                        stroke-linejoin="round" stroke-width="2"
                                                            ...
                                                            <p class="text-red-700 mb-2">
                                                                {{ $reservaSeleccionada->motivo_cliente }}</p>
                                                            @if ($reservaSeleccionada->fecha_solicitud_cancelacion)
                                                                <div class="flex items-center text-red-600 text-sm">
                                                                    <svg class="w-4 h-4 mr-1" fill="none"
                                                                        stroke="currentColor" viewBox="0 0 24 24">
                                            ...
                                            @if ($reservaSeleccionada->paquete->duracion || $reservaSeleccionada->paquete->precio_por_persona)
                                                <div class="bg-gray-50 rounded-lg p-6 mb-6">
                                                    <h4 class="text-xl font-semibold text-gray-800 mb-4">Detalles del
                                                        Paquete</h4>
                                                    ...
                                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                                        @if ($reservaSeleccionada->paquete->duracion)
                                                            <div class="bg-white p-4 rounded-lg shadow-sm">
                                                                <div class="flex items-center mb-2">
                                                                    <svg class="w-5 h-5 text-purple-500 mr-2"
                                                                    ...
                                                                    <span
                                                                        class="font-medium text-gray-700">Duración</span>
                                                                </div>
                                                                <p class="text-gray-900 font-semibold">
                                                                    {{ $reservaSeleccionada->paquete->duracion }}</p>
                                                            </div>
                                                        ...
                                                        @if ($reservaSeleccionada->paquete->precio_por_persona)
                                                            <div class="bg-white p-4 rounded-lg shadow-sm">
                                                                <div class="flex items-center mb-2">
                                                                    ...
                                                                    <span class="font-medium text-gray-700">Precio por
                                                                        persona</span>
                                                                </div>
                                                                <p class="text-gray-900 font-semibold">S/.
                                                                    {{ number_format($reservaSeleccionada->paquete->precio_por_persona, 2) }}
                                        ...
                                        <!-- Footer del modal -->
                                        <div
                                            class="sticky bottom-0 bg-white border-t border-gray-200 p-6 rounded-b-lg">
                                            <div class="flex justify-between items-center">
                                                <div class="text-sm text-gray-500">
                                                    Reserva #{{ $reservaSeleccionada->id }}
                                                </div>
