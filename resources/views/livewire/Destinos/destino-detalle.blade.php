        ...
        <div class="relative z-10 container mx-auto px-4 h-full flex items-center">
            <div class="text-white max-w-3xl">
                <div class="flex items-center mb-4">
                    <span class="bg-yellow-400 text-black text-sm font-bold px-3 py-1 rounded-full mr-3">Mejor
                        valorado</span>
                ...
                <p class="text-xl text-gray-200">Descubre los paisajes más espectaculares de los Andes peruanos en esta
                    inolvidable expedición de alta montaña.</p>
            </div>
        </div>
    </div>
            ...
            <div class="lg:col-span-2">
                    ...
                    <div class="grid md:grid-cols-2 gap-6 mb-6">
                        <div class="flex items-center">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-gray-600">Cancela con hasta 24 horas de antelación y recibe un
                        ...
                        <div class="flex items-center">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-gray-600">Comprueba la disponibilidad para ver los horarios de
                                    inicio</p>
                            </div>
                        </div>
                ...
                <div class="bg-white rounded-xl shadow-md p-6 mb-8">
                    ...
                    <p class="text-gray-600 leading-relaxed mb-4">
                        Vive una experiencia única en la Cordillera Huayhuash, considerada una de las rutas de trekking
                        más espectaculares del mundo. Durante 5 días, caminarás por paisajes de ensueño, rodeado de
                        picos nevados que superan los 6,000 metros de altura, lagunas de color turquesa y valles
                        glaciares que te dejarán sin aliento.
                    </p>
                    <p class="text-gray-600 leading-relaxed">
                        Este circuito te llevará por algunos de los lugares más remotos y pristinos de los Andes
                        peruanos, incluyendo vistas del imponente Yerupajá (6,617m), la segunda montaña más alta del
                        Perú. Nuestros guías expertos te acompañarán en cada paso, compartiendo su conocimiento sobre la
                        flora, fauna y cultura local de esta región extraordinaria.
                    </p>
                </div>
                ...
                <div class="bg-white rounded-xl shadow-md p-6">
                    ...
                    <div class="space-y-6">
                        <div class="border-b pb-6">
                            ...
                            <p class="text-gray-600">"Una experiencia increíble. Los paisajes son simplemente
                                espectaculares y el servicio del equipo fue excepcional. Totalmente recomendado para los
                                amantes del trekking."</p>
                        </div>
                        ...
                        <div class="border-b pb-6">
                            ...
                            <p class="text-gray-600">"La organización fue perfecta desde el primer día. Los guías muy
                                profesionales y conocedores de la zona. Sin duda, una de las mejores aventuras que he
                                vivido."</p>
                        </div>
                    </div>
                </div>
            ...
            <div class="lg:col-span-1">
                <div class="bg-white rounded-xl shadow-lg p-6 sticky top-4">
                    <div class="text-center mb-6">
                        <span class="bg-red-100 text-red-800 text-sm font-semibold px-3 py-1 rounded-full">Casi
                            agotado</span>
                    </div>
                    ...
                    <div class="text-center mb-4">
                        <span class="text-sm text-gray-600">
                            <span class="underline cursor-pointer">Reservar ahora y pagar después</span> te permite
                            asegurarte una plaza, sin que se realice ningún cargo hoy
                        </span>
                    </div>
