                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    <div class="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-xl transition duration-300">
                        ...
                        <div class="p-6">
                            ...
                            <p class="text-gray-600 mb-4">Disfruta de un tour conociendo una de las lagunas más famosas
                                de
                                Áncash.</p>
                    ...
                    <div class="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-xl transition duration-300">
                        ...
                        <div class="p-6">
                            ...
                            <p class="text-gray-600 mb-4">Aventura de 5 días por la espectacular Cordillera Huayhuash.
                            </p>
                    ...
                    <div class="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-xl transition duration-300">
                        ...
                        <div class="p-6">
                            ...
                            <p class="text-gray-600 mb-4">Recorrido por los principales atractivos culturales e
                                históricos
                                de
                                la ciudad.</p>
